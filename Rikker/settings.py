...
STATICFILES_DIRS = (
    ...
    os.path.join(BASE_DIR, 'Rikker/static'),
...
SECRET_KEY = 'usv#^ojsr(mggoy60b!4geap^homfulw9_4=9r3p=4_r(1m)9v'
...
ROOT_URLCONF = 'Rikker.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'Rikker.wsgi.application'
